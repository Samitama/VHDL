...
HD_PWD='C:/Users/Sami/Documents/vhdl/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hex_to_sseg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hex_to_sseg.tcl -notrace
