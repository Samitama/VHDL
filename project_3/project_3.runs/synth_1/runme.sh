...
HD_PWD='C:/Users/Sami/Documents/vhdl/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hex_to_sseg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hex_to_sseg.tcl
